<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeFile="CustomizedSoftware.aspx.cs" Inherits="CustomizedSoftware" %>
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="main-about-page">
                            <div class="about-heading-page">
                                <h2 class="wow fadeIn" data-wow-delay="0s">Customized <span>Software Solutions</span></h2>
                                 
                            </div>
                            <div class="about-paraPage">
                                <p class="wow fadeInUp" data-wow-delay=".4s">
                                    To create, design, and maintain software we try to be the perfect custom software company. Whenever we need to fit organizational requirements rather than purchased-off the sheet software. Our custom software development services prove to be a great tool. Our customized software solutions help.
                                </p>
                            </div>
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="page-about-image">
                            <div class="about-imagePage wow fadeIn" data-wow-delay=".6s">
                                <img src="assets/images/banner/custom-web.jpeg" width="490" height="378" alt="Customized-Software-Solutions">
                            </div>
                        </div>
                    </div>
                </div>
