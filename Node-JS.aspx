<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeFile="Node-JS.aspx.cs" Inherits="Node_JS" %>
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="main-about-page">
                            <div class="about-heading-page">
                                <h2 class="wow fadeIn" data-wow-delay="0s">Node JS
                                    <span>Development</span></h2>
                                 
                            </div>
                            <div class="about-paraPage wow fadeInUp" data-wow-delay=".4s">
                                <p>We are the best node js software development company. We offer end-to-end services including application development, nodejs migration, consulting services and support. 
                                    It helps to ensure reliability, scalability, and stability.
                                    Our nodejs software development brings event-driven performance .It enables development of fast web-services and uses a simplified model of event-driven programming.
                                </p>
                            </div> 
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="page-about-image">
                            <div class="about-imagePage wow fadeIn" data-wow-delay=".6s">
                                <img src="assets/images/banner/21.png" alt="serviceDetail_page_image" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        <div class="main-about-page">
                            <div class="about-paraPage wow fadeInUp" data-wow-delay=".4s">
                                <p>
                                    Node js application development helps to write javascript for both client and server side. It helps in enabling synchronization of real-time applications.
                                    We are an efficient nodejs software development service provider including agile and scalable network applications, ios and Android apps.
                                </p>
                            </div>
                        </div>
                    </div>
