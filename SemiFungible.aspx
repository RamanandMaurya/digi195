<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeFile="SemiFungible.aspx.cs" Inherits="SemiFungible" %>
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="main-about-page">
                            <div class="about-heading-page">
                                <h2 class="wow fadeIn" data-wow-delay="0s">Semi fungible<a style="text-transform: lowercase"></a>
                                    <span>Token Development</span></h2>
                                 
                            </div>
                            <div class="about-paraPage wow fadeInUp" data-wow-delay=".4s">
                                <p>We are a leading semi-fungible token development company. With the ease and talent of our professionals, we try to create multi-faceted semi fungible tokens.
                                    We are one of the top leading semi-fungible token development solutions providing a company providing a wide platform of gaming solutions.
                                </p>
                            </div> 
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        <div class="main-about-page">
                            <div class="about-paraPage wow fadeInUp" data-wow-delay=".4s">
                                <p>
                                    It gets used in single smart contracts too. With the help of our semi fungible token development services, we create a token for every new transaction for every different contract.
                                <br>We are the best semi-fungible token development company.</p>
                                <p>To empower digital content creators to grow in a democratic environment . Our NFT token development services are doing  their level best!
                                </p>
                            </div>
                        </div>
                    </div>
