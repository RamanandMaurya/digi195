<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeFile="iosDevelopment.aspx.cs" Inherits="iosDevelopment" %>
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="main-about-page">
                            <div class="about-heading-page">
                                <h2 class="wow fadeIn" data-wow-delay="0s"><a style="text-transform:lowercase;">i</a>OS App <span>Development</span></h2>
                                 
                            </div>
                            <div class="about-paraPage wow fadeInUp" data-wow-delay=".4s">
                                <p>
                                    At Digi 195 we have the code experts who are specialised in providing iOS app
                                    development services. This IT solution company allows you to create custom and
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="page-about-image">
                            <div class="about-imagePage wow fadeIn" data-wow-delay=".6s">
                                <img src="assets/images/banner/18.png" alt="serviceDetail_page_image" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        <div class="main-about-page">
                            <div class="about-paraPage wow fadeInUp" data-wow-delay=".4s">
                                <p>
                                    Our IOS development company provides a highly developed design and delivers an iOs application development lifecycle.
                                With a view to create interactive and user- friendly mobile apps, iOs devices come into quite-friendly.
                                We have efficient iOs analyzers that help businesses to maximize ROI.
                                </p>
                                <p>There are many best company that work as iOs developers.
                                    Digi 195 is one of the best performing company providing best iOs services. The best company to iOs development mobile and web apps that people love and have long-term partners for start-ups and enterprises.
                                    We have efficient iOs development  with a deep understanding of iOs ecosystem.
                                </p>
                            </div>
                        </div>
                    </div>
