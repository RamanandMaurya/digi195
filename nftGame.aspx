<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeFile="nftGame.aspx.cs" Inherits="nftGame" %>
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="main-about-page">
                            <div class="about-heading-page">
                                <h2 class="wow fadeIn" data-wow-delay="0s">NFT Game
                                    <span>Development</span></h2>
                                 
                            </div>
                            <div class="about-paraPage wow fadeInUp" data-wow-delay=".4s">
                                <p>We are a NFT marketplace development company providing a service to allow users to mint a token and create a feature of token creation for the NFT marketplace.
                                    Multiple security layers can be easily integrated with the help of NFT marketplace development services.
                                </p>
                            </div> 
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        <div class="main-about-page">
                            <div class="about-paraPage wow fadeInUp" data-wow-delay=".4s">
                                <p>
                                    Being one of the best NFT marketplace development company,  we provide a strong foundation in decentralized apps. We are quite efficient in serving clients across  the globe and different domains of industry.
                                    Multiple security layers can be easily integrated with the help of NFT marketplace development services. 
                                </p>
                                <p>We are proving the term to be the best NFT marketplace development company.
                                    NFT game development solutions are the  leading demand of today’s generation.We provide high-quality NFT game development services.
                                </p>
                            </div>
                        </div>
                    </div>
